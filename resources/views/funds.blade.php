...
<table width="100%" border="0">
    <td bgcolor="#90ee90"width="50%">
        ...
        <div class="col-md-12 animate-box fadeInUp animated-fast" width="50%">
            ...
            <div class="container" style="background-color: white">
                ...
                <form class="form-horizontal" action='fstore'>
                    ...
                    <div class="form-group{{ $errors->has('Year') ? ' has-error' : '' }}">
                        <label for="FundName" class="col-md-4 control-label">MonthYear</label>

                        <div class="col-md-8">
                            <input id="Year" type="text" class="form-control" name="MonthYear" placeholder="MonthYear" value="{{ old('MonthYear') }}" required>
                    ...
                    <div class="form-group{{ $errors->has('Year') ? ' has-error' : '' }}">
                        <label for="FundName" class="col-md-4 control-label">Year</label>
    ...
    <td bgcolor="#90ee90"width="50%">
        ...
        <img src="/img/funds.jpg"width="1100" height="750"></td>
