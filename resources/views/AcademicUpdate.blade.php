...
<table width="100%" border="0">
    <td bgcolor="#90ee90"width="50%">
        ...
        <h1 font-color="White" align="center" >Academic Staff Salary Payment Details</h1>
        ...
        <div class="col-md-12 animate-box fadeInUp animated-fast" width="50%">
            ...
            <div class="container" style="background-color: white">
                ...
                <form class="form-horizontal" action='{{url('Aupdate')}}' method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('EmpNo') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-8">
                            <input id="EmpNo" type="text" class="form-control" name="EmpNo" placeholder="EmpNo" value="{{$id }}" required>
                            @if ($errors->has('EmpNo'))
