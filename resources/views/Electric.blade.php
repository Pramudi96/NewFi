...
<table width="100%" border="0">
    <td bgcolor="#90ee90"width="50%">
        ...
        <div class="col-md-12 animate-box fadeInUp animated-fast" width="50%">
            ...
            <div class="container" style="background-color: white">
                ...
                <form class="form-horizontal" action='{{Route('estore')}}'>
    ...
    <td bgcolor="#90ee90"width="50%">
        ...
        <form action="eindex" method="post">
            {{ csrf_field() }}
        ...
        <img src="/img/ebill.jpg"width="1100" height="750"></td>
